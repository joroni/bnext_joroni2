        ...
        <div class="footer-main">
            <div class="row">
                <div class="col-three md-1-3 tab-full footer-info mc">
                    ...
                    <?php
$query = new WP_Query( array( 'category_name' => 'location' ) );
if ( $query->have_posts() ) :
...
?>
                ...
                <div class="col-three md-1-3 tab-1-2 mob-full footer-contact">
                    <h4>Social</h4>
                    <?php
$query = new WP_Query( array( 'category_name' => 'social-links' ) );
if ( $query->have_posts() ) :
    while ( $query->have_posts() ) : $query->the_post();
   the_content();
       endwhile;
            ...
            <div class="row">
                <div class="col-twelve">
                    <div class="copyright">
                        ...
                        <span>Design by <a href="<?php echo esc_url( home_url( '/' ) ); ?>">bneXt</a></span>
                    </div>
                    <div id="go-top">
...
<script>
    $(document).ready(function () {
        $('img.parallax-slider').attr('src', 'https://www.gravatar.com/avatar/e56672acdbce5d9eda58a178ade59ffe');
        $('a.sliderNav').on('click', function(){
            $('a.sliderNav').parent().removeClass('cd-selected');
            $(this).parent().addClass('cd-selected');
        })
